  ...
  return (
    <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden bg-gradient-to-b from-cream via-[#fcf5f5] to-cream">
      ...
      <div className="relative z-10 max-w-3xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <h1 className="font-serif text-6xl md:text-8xl text-dark-text leading-tight">
        ...
        <p className="max-w-md mx-auto text-gray-500 text-lg leading-relaxed font-light">
